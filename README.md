...
2. Run the cells sequentially; each cell is self-contained and ends with a ✅ marker when it finishes successfully.
...
The notebook compiles cell-by-cell under Python 3.10+ and is tuned for "studio-ready" reliability, determinism, and maintainability.
